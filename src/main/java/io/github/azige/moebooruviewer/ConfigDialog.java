...
public class ConfigDialog extends javax.swing.JDialog{
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("杂项"));

        safeModeCheckBox.setText("安全模式");
        safeModeCheckBox.setToolTipText("过滤出适合在公众场合或上班时间浏览的图片");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder("图片保存位置"));

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("分类1"));

        jLabel1.setText("名字");

        saveNameTextField1.setText("壁纸");

        jLabel2.setText("路径");

        savePathTextField1.setText("wallpaper");

        choosePathButton1.setText("选择");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("分类2"));

        jLabel3.setText("名字");

        saveNameTextField2.setText("可公开收藏");

        jLabel4.setText("路径");

        savePathTextField2.setText("collections");

        choosePathButton2.setText("选择");
        ...
        jPanel7.setBorder(javax.swing.BorderFactory.createTitledBorder("分类4"));

        jLabel9.setText("名字");

        saveNameTextField4.setText("暂存");

        jLabel10.setText("路径");

        savePathTextField4.setText("recycler");

        choosePathButton4.setText("选择");
        ...
        jPanel8.setBorder(javax.swing.BorderFactory.createTitledBorder("分类3"));

        jLabel11.setText("名字");

        saveNameTextField3.setText("非公开收藏");

        jLabel12.setText("路径");

        savePathTextField3.setText(".collections");

        choosePathButton3.setText("选择");
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder("外观"));

        lafComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Windows" }));

        jLabel5.setText("需要重启");
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createTitledBorder("分页设置"));

        jLabel6.setText("页大小");

        pageSizeTextField.setText("20");

        jLabel7.setText("上限是 100");
